...
export const DriversToIncorporateSustainability = ({
  ...
  const responseRate = totalResponses > 0 ? (totalRespondentsWithAnswer / totalResponses) * 100 : 0;
...
export const DriversToIncorporateSustainabilityDetails = ({ onBack }: { onBack: () => void }) => {
  ...
  const responseRate =
    numberOfOtherSelections > 0 ? (driveOtherTexts.length / numberOfOtherSelections) * 100 : 0;
