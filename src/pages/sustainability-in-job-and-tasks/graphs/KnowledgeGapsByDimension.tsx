...
const KnowledgeGapsByDimension = () => {
    const questionHeader = "Which sustainability dimension(s) do you feel you lack sufficient knowledge or tools to effectively address?";
    const questionHeaderOther =
        columnDefinitions.find((c) => c.key === "lackKnowledgeOther")?.header
