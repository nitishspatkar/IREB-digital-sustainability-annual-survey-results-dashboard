...
const HindrancesToIncorporateSustainability = () => {
    const questionHeader = "What hinders you from incorporating sustainability in your role-specific tasks?";
    const questionHeaderOther =
        columnDefinitions.find((c) => c.key === "hindranceOther")?.header
