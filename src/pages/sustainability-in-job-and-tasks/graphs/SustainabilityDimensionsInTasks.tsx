...
const SustainabilityDimensionsInTasks = () => {
    const questionHeader = "Which sustainability dimensions do you consider in your role-specific tasks?";
    const questionHeaderOther =
        columnDefinitions.find((c) => c.key === "roleConsiderOther")?.header
