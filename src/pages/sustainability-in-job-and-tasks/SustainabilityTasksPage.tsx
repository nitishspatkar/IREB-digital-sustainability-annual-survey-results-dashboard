...
// Imports
// Updated Import
import { AdditionalSupportResources, AdditionalSupportResourcesDetails } from "./graphs/AdditionalSupportResources";
import { DriversToIncorporateSustainability, DriversToIncorporateSustainabilityDetails } from "./graphs/DriversToIncorporateSustainability";
import { HindrancesToIncorporateSustainability, HindrancesToIncorporateSustainabilityDetails } from "./graphs/HindrancesToIncorporateSustainability";
import { KnowledgeGapsByDimension, KnowledgeGapsByDimensionDetails } from "./graphs/KnowledgeGapsByDimension";
import PersonIncorporatesSustainability from "./graphs/PersonIncorporatesSustainability";
import { SustainabilityDimensionsInTasks, SustainabilityDimensionsInTasksDetails } from "./graphs/SustainabilityDimensionsInTasks";
        ...
        <div className="space-y-6">
            <header>
                ...
                <p className="mt-2 max-w-2xl text-sm text-ireb-grey-01 font-mori">
                    ...
                    role-specific tasks based on the latest survey data.
                </p>
            </header>
            <div className="grid grid-cols-1 gap-18">
                ...
                <GraphAnchor id="graph-knowledge-gaps">
                    <KnowledgeGapsByDimension
                        onExplore={() => setActiveView("knowledge_gaps")}
                    />
                </GraphAnchor>
                ...
                <GraphAnchor id="graph-support-resources">
                    <AdditionalSupportResources
                        onExplore={() => setActiveView("support_resources")}
                    />
                </GraphAnchor>
            </div>
        </div>
