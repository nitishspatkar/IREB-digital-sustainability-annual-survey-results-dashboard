...
const NoTrainingReasons = () => {
    const questionHeader = "What might be the reasons your organization does not offer any or more training or resources on the design or development of sustainable digital solutions?";
    const questionHeaderOther =
        columnDefinitions.find((c) => c.key === "orgNoTrainingOther")?.header
