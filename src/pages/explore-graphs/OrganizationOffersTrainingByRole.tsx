...
const extractOrganizationOffersTrainingByRoleData: DataExtractor<HorizontalBarData> = (
  responses
) => {
...
// --- The Processor Logic ---
const processOrganizationOffersTrainingByRole: ChartProcessor = (responses, palette) => {
...
// --- The Component ---
export const OrganizationOffersTrainingByRole = ({
  onBack,
  showBackButton = true,
}: {
  onBack: () => void;
  ...
  return (
    <GenericChart
      graphId="OrganizationOffersTrainingByRole"
      processor={processOrganizationOffersTrainingByRole}
      layout={layout}
      isEmbedded={true}
      onBack={showBackButton ? onBack : undefined}
      dataExtractor={extractOrganizationOffersTrainingByRoleData}
