...
const extractOrganizationReportsOnSustainabilityByOrgTypeData: DataExtractor<HorizontalBarData> = (
  responses
) => {
...
// --- The Processor Logic ---
const processOrganizationReportsOnSustainabilityByOrgType: ChartProcessor = (
  responses,
  palette
) => {
...
// --- The Component ---
export const OrganizationReportsOnSustainabilityByOrgType = ({
  onBack,
  showBackButton = true,
}: {
  onBack: () => void;
  ...
  return (
    <GenericChart
      graphId="OrganizationReportsOnSustainabilityByOrgType"
      processor={processOrganizationReportsOnSustainabilityByOrgType}
      layout={layout}
      isEmbedded={true}
      onBack={showBackButton ? onBack : undefined}
      dataExtractor={extractOrganizationReportsOnSustainabilityByOrgTypeData}
