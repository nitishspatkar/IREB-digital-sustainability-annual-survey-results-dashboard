...
// --- The Component ---
export const OrganizationHasSustainabilityTeamByAge = ({
  onBack,
  showBackButton = true,
}: {
  onBack: () => void;
  ...
  return (
    <GenericChart
      graphId="OrganizationHasSustainabilityTeamByAge"
      processor={processOrganizationHasSustainabilityTeamByAge}
      layout={layout}
      isEmbedded={true}
