...
const extractOrganizationIncorporatesPracticesByRoleData: DataExtractor<HorizontalBarData> = (
  responses
) => {
...
// --- The Processor Logic ---
const processOrganizationIncorporatesPracticesByRole: ChartProcessor = (responses, palette) => {
...
// --- The Component ---
export const OrganizationIncorporatesPracticesByRole = ({
  onBack,
  showBackButton = true,
}: {
  onBack: () => void;
  ...
  return (
    <GenericChart
      graphId="OrganizationIncorporatesPracticesByRole"
      processor={processOrganizationIncorporatesPracticesByRole}
      layout={layout}
      isEmbedded={true}
      onBack={showBackButton ? onBack : undefined}
      dataExtractor={extractOrganizationIncorporatesPracticesByRoleData}
