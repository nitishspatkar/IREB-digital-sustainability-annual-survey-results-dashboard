...
const extractOrganizationReportsOnSustainabilityByAgeData: DataExtractor<HorizontalBarData> = (
  responses
) => {
...
// --- The Processor Logic ---
const processOrganizationReportsOnSustainabilityByAge: ChartProcessor = (responses, palette) => {
...
// --- The Component ---
export const OrganizationReportsOnSustainabilityByAge = ({
  onBack,
  showBackButton = true,
}: {
  onBack: () => void;
  ...
  return (
    <GenericChart
      graphId="OrganizationReportsOnSustainabilityByAge"
      processor={processOrganizationReportsOnSustainabilityByAge}
      layout={layout}
      isEmbedded={true}
      onBack={showBackButton ? onBack : undefined}
      dataExtractor={extractOrganizationReportsOnSustainabilityByAgeData}
