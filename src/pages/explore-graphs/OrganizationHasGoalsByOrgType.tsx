...
const extractOrganizationHasGoalsByOrgTypeData: DataExtractor<HorizontalBarData> = (responses) => {
...
// --- The Processor Logic ---
const processOrganizationHasGoalsByOrgType: ChartProcessor = (responses, palette) => {
...
// --- The Component ---
export const OrganizationHasGoalsByOrgType = ({
  onBack,
  showBackButton = true,
}: {
  onBack: () => void;
  ...
  return (
    <GenericChart
      graphId="OrganizationHasGoalsByOrgType"
      processor={processOrganizationHasGoalsByOrgType}
      layout={layout}
      isEmbedded={true}
      onBack={showBackButton ? onBack : undefined}
      dataExtractor={extractOrganizationHasGoalsByOrgTypeData}
