...
const extractOrganizationOffersTrainingByOrgTypeData: DataExtractor<HorizontalBarData> = (
  responses
) => {
...
// --- The Processor Logic ---
const processOrganizationOffersTrainingByOrgType: ChartProcessor = (responses, palette) => {
...
// --- The Component ---
export const OrganizationOffersTrainingByOrgType = ({
  onBack,
  showBackButton = true,
}: {
  onBack: () => void;
  ...
  return (
    <GenericChart
      graphId="OrganizationOffersTrainingByOrgType"
      processor={processOrganizationOffersTrainingByOrgType}
      layout={layout}
      isEmbedded={true}
      onBack={showBackButton ? onBack : undefined}
      dataExtractor={extractOrganizationOffersTrainingByOrgTypeData}
