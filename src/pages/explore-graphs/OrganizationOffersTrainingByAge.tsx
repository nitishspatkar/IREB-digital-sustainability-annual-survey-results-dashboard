...
const extractOrganizationOffersTrainingByAgeData: DataExtractor<HorizontalBarData> = (
  responses
) => {
...
// --- The Processor Logic ---
const processOrganizationOffersTrainingByAge: ChartProcessor = (responses, palette) => {
...
// --- The Component ---
export const OrganizationOffersTrainingByAge = ({
  onBack,
  showBackButton = true,
}: {
  onBack: () => void;
  ...
  return (
    <GenericChart
      graphId="OrganizationOffersTrainingByAge"
      processor={processOrganizationOffersTrainingByAge}
      layout={layout}
      isEmbedded={true}
      onBack={showBackButton ? onBack : undefined}
      dataExtractor={extractOrganizationOffersTrainingByAgeData}
