...
const extractOrganizationHasSustainabilityTeamByRoleData: DataExtractor<HorizontalBarData> = (
  responses
) => {
...
// --- The Processor Logic ---
const processOrganizationHasSustainabilityTeamByRole: ChartProcessor = (responses, palette) => {
...
// --- The Component ---
export const OrganizationHasSustainabilityTeamByRole = ({
  onBack,
  showBackButton = true,
}: {
  onBack: () => void;
  ...
  return (
    <GenericChart
      graphId="OrganizationHasSustainabilityTeamByRole"
      processor={processOrganizationHasSustainabilityTeamByRole}
      layout={layout}
      isEmbedded={true}
      onBack={showBackButton ? onBack : undefined}
      dataExtractor={extractOrganizationHasSustainabilityTeamByRoleData}
