...
1. Upload new data file to the GitHub.
   ...
   4. It should be automatically deployed by our Pipeline, this should take around 1.5 Minutes.
...
5. It should be automatically deployed by our Pipeline, this should take around 1.5 Minutes. <img width="2899" height="814" alt="image" src="https://github.com/user-attachments/assets/5b0b9d25-4fa2-4f7f-9d8a-3f5078de1d31" />
